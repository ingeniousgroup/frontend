...
function CategoryProperty() {
    ...
    return <>
        ...
        <div className='container-fluid'>
            <div className='row'>
                <div className='col-2 bg-info sideFilter'>
                    
                </div>
                <div className='col-10'>
                    <div>
                        <h2 className='text-center mt-4'>
                            <label className='text-primary'><u>{furn.state.toUpperCase()}</u></label> Products...
                        </h2>
                    </div>
                        ...
                        {categoryByFurnishing?.map((data, index) => data.property.map((property, proIndex) => <div className="col-md-3">
                            ...
                            <div className="profile-textDiv">
                                ...
                                <div className="posted-property ">
                                    <span>PostedOn</span><span className="paddingStyle"><a href="#" className='ms-4'>{property.date}</a></span>
                                </div>
                            </div>
                        </div>))}
                    </div>
