...
import {
  createSubscription,
  showSubscription,
} from "../../../redux-config/subscriptionSlice";
                ...
                <div className="row ms-5" style={{ marginLeft: "-80px" }}>
                  <div className="col-md-6 text-end ">
                    <button
                      ...
                      className="btn  rounded-pill btn-light mt-1 post"
                    >
                      Post Property
                    </button>
                  </div>
                  <div className="col-md-6">
                    ...
                    {subscription && (
                      <button className="btn post rounded-pill mt-1 btn-light">
                        Subscribed
                      </button>
                    )}
                  </div>
