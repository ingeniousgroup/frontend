...
function Navbar({ search }) {
  ...
  const signinUser = () => {
    Swal.fire({
      ...
      else navigate("/signin", { state: { status: false } });
    });
  };
  ...
  return (
    <header className="main-header" style={{ marginBottom: "10vh" }}>
      <div className="container-fluid">
        <nav className="navbar navbar-expand-lg main-nav px-0  container-fluid bgc">
          <div className="navbar-brand">
           ...
           <img className="logoimg-n" src="images/kirayewalaLogo.png"/>
          </div>
          <button
          ...
          <div className="collapse navbar-collapse" id="mainMenu">
            <ul
              className="navbar-nav ml-auto  f1 "
              style={{ fontWeight: "700", opacity: "100%" }}
            >
              <li>
                <Link to="/" className=" active-first fs-5 font-weight-bold">
                  Home
                </Link>
              </li>
              <li>
                <Link
                  ...
                  style={{ opacity: "400%", fontWeight: "600px" }}
                >
                  About{" "}
                </Link>
              </li>
              <li>
                <Link to="/services" className="fs-5 font-weight-bold">
                  Services
                </Link>
              </li>
              {currentUser?.role === "Tenant" ? (
                ...
                <li>
                  <Link to="/propertypost" className="fs-5  font-weight-bold">
                    Post Property{" "}
                  </Link>
                </li>
              )}
